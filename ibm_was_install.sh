...
media_full_path=/tmp/WAS_ND_V9.0_MP_ML.zip
extraction_full_path=/tmp/WAS_ND_V9.0_MP_ML
im_path=/opt/IBM/IM
was_install_dir=/opt/IBM/WAS/AppServer
...
was_id=$($im_path/eclipse/tools/imcl listAvailablePackages -repositories $extraction_full_path | grep "ND.v")
sdk_id=$($im_path/eclipse/tools/imcl listAvailablePackages -repositories $sdkextraction_full_path)
$im_path/eclipse/tools/imcl install $was_id $sdk_id -repositories $extraction_full_path,$sdkextraction_full_path  -installationDirectory $was_install_dir -acceptLicense -showProgress
